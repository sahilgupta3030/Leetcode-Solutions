...
private:
    // Returns the number of powerful integers, considering the i-th digit,
    // where `tight1` indicates if the current digit is tightly bound for `a`
    // and `tight2` indicates if the current digit is tightly bound for `b`.
